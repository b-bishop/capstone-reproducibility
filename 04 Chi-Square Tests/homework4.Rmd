...
From examining the table, it appears that there might more individuals in the experiemental condition in agreement than in the control control.
...
between condition and agreement, I performed a chi-square test.

```{r}
chisq.test(dat$condition,dat$agreement)
```

According to the results of the chi-square test,condition and agreement
are independent of one another Chi-square(1) = 1.28, p = .26.
